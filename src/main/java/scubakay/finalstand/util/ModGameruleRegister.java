...
public class ModGameruleRegister {
    ...
    public static final GameRules.Key<GameRules.IntRule> SESSION_HUNTER_SELECTION_TIME = GameRuleRegistry.register("hunterSelectionTime", Category.MISC, GameRuleFactory.createIntRule(10, 1));
    public static final GameRules.Key<GameRules.IntRule> SESSION_TREASURE_CHEST_TIME = GameRuleRegistry.register("treasureChestTime", Category.MISC, GameRuleFactory.createIntRule(15, 1));
